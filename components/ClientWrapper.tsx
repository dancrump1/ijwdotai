...
const cn = dynamic(() => import("@/lib/utils").then((mod) => mod.cn), {
	loading: ComponentLoading,
});
const Image1 = dynamic(() => import("@/public/itjustworks.jpg"), {
	loading: ComponentLoading,
});
...
const CSSBoxRef = dynamic(
	() => import("@/registry/open-source/CSSBox").then((mod) => mod.CSSBoxRef),
	{ loading: ComponentLoading }
);
...
const GooeyFilter = dynamic(
	() =>
		import("@/registry/open-source/GooeyTabs").then((mod) => mod.GooeyFilter),
	{ loading: ComponentLoading }
);
