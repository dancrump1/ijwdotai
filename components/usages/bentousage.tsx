...
const Skeleton = () => (
	<div className="flex flex-1 w-full h-full min-h-[6rem] rounded-xl bg-gradient-to-br from-background dark:from-background dark:to-background to-background"></div>
);
const items = [
	{
