...
const X = {
	count: 200,
	colors: [16711680, 16711680, 16711680], // How you change the ball colors
	...
	minSize: 0.4, // Change min size of non-control balls
	maxSize: 0.6, // Change max size of non-control balls
	size0: 0.75, // Change size of controlled ball
	gravity: 0.5,
	friction: 0.9975,
	wallBounce: 0.95,
	maxVelocity: 0.15,
