	...
	return (
		<AnimatePresence mode="wait">
			...
			>
				...
				<button className="border text-sm font-medium relative border-neutral-200 dark:border-white/[0.2] text-foreground dark:text-foreground px-4 py-2 rounded-full">
					<span>Login</span>
