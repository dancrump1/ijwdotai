		...
		>
			<div className="relative flex flex-1 scale-y-125 items-center w-full justify-center isolate z-0 ">
				<motion.div
					...
					// }}
					className="from-[#D23A2A] via-transparent to-transparent absolute inset-auto right-1/2 h-56 overflow-visible w-[30rem] bg-gradient-conic text-foreground [--conic-position:from_70deg_at_center_top]"
				>
				...
				<motion.div
					...
					//   backgroundImage: `conic-gradient(var(--conic-position),  var(--tw-gradient-from), var(--tw-gradient-to);)`,
					// }}
					className="from-transparent via-transparent to-[#D23A2A] absolute inset-auto left-1/2 h-56 w-[30rem] bg-gradient-conic text-foreground [--conic-position:from_290deg_at_center_top]"
				>
				...
				<div className="absolute inset-auto z-40 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-background opacity-50 blur-2xl"></div>
				...
				<motion.div
					...
					className="absolute inset-auto z-40 h-0.5 w-[30rem] -translate-y-[7rem] bg-background"
				></motion.div>
