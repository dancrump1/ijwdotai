...
export const MaskContainer = ({
	...
	return (
		...
		>
			<motion.div
				className="w-full h-full flex items-center justify-center text-6xl absolute bg-background bg-grid-white/[0.2] text-foreground [mask-image:url(/mask.svg)] [mask-size:40px] [mask-repeat:no-repeat]"
				animate={{
