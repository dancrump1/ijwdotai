	...
	return (
		...
		>
			...
			<div className="text-lg font-bold mb-2 relative z-10 px-10">
				<div className="absolute left-0 inset-y-0 h-6 group-hover/feature:h-8 w-1 rounded-tr-full rounded-br-full bg-neutral-300 dark:bg-neutral-700 group-hover/feature:bg-[#2c3e5a] transition-[height,background-color] duration-200 origin-center" />
				<span className="group-hover/feature:translate-x-2 transition duration-200 inline-block text-neutral-800 dark:text-neutral-100">
					{title}
				</span>
			</div>
			<span className="text-sm text-neutral-600 dark:text-neutral-300 lg:max-w-[75%] relative z-10 px-10">
				{description}
			</span>
		</div>
	);
